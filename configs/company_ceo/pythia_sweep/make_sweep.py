...
for seed in (0,1):
  for model in layer_count_dictionary:
    ...
    for i in range(SWEEP_SIZE):
      ...
      config['logfile'] = 'pythiaresults/{}-company-full-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
      ...
      config['resultsfile'] = 'pythiaresults/{}-company-full-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}.results.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
    ...
    for i in range(SWEEP_SIZE):
      ...
      config['logfile'] = 'pythiaresults/{}-company-lora-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}-lorarank{}-loratgt{}.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
      ...
      config['resultsfile'] = 'pythiaresults/{}-company-lora-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}-lorarank{}-loratgt{}.results.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
