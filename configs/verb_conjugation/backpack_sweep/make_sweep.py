...
#threshold = -np.log(.5).item()
threshold = np.log(1/16).item()
...
sense_regularization_distribution = lambda: 0
...
for seed in (0,1):
  for model in layer_count_dictionary:
    ...
    for i in range(SWEEP_SIZE):
      ...
      config['logfile'] = 'backpackresults/{}-verb-full-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
      ...
      config['resultsfile'] = 'backpackresults/{}-verb-full-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}.results.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
    ...
    for i in range(SWEEP_SIZE):
      ...
      #lora_target_string = lora_distribution()
      ...
      config['logfile'] = 'backpackresults/{}-verb-lora-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}-lorarank{}-loratgt{}.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
      ...
      config['resultsfile'] = 'backpackresults/{}-verb-lora-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}-lorarank{}-loratgt{}.results.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
    ...
    for i in range(SWEEP_SIZE):
      ...
      #config['training']['lora']['target_modules'] = lora_target_string
      #config['training']['lora']['lora_rank'] = lora_rank
      #config['senses']['max_senses_total'] = sense_count
      ...
      config['logfile'] = 'backpackresults/{}-verb-sense-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}-sensec{}-sensereg{}.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
      ...
      config['resultsfile'] = 'backpackresults/{}-verb-sense-lr{:.2E}-epochs{}-regtype{}-regw{:.2E}-sensec{}-sensereg{}.results.out.seed{}'.format(
          safe_model,
          lr,
          epoch_count,
          regularization_type,
